    ...
    <div class="container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Product Category<b>Data</b></h2>
                    </div>
                </div>
        ...
        <div class="modal fade" id="ajax-modal" aria-hidden="true">
            ...
            <form action="javascript:void(0)" id="productForm" name="productForm" class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="pname" name="pname" placeholder="Enter Product Category" value="" maxlength="50" required="">
                </div>
              </div>  
              <div class="form-group">
                <label for="name" class="col-sm-2 control-label">Description</label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="desc" name="desc" placeholder="Enter Product Description" value="" maxlength="100" required="">
                </div>
              </div>  
...
$('#create').click(function () {
   ...
   $('#ProductModal').html("Add New Product Category");
...
$('body').on('click', '.edit', function () {
    ...
    $.ajax({
        ...
        success: function(res){
          $('#ProductModal').html("Edit Product Category");
          $('#ajax-modal').modal('show');
          $('#productId').val(res.pid);
          $('#pname').val(res.product_type);
